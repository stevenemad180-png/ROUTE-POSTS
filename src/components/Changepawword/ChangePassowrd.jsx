...
const passwordobj = zod
  .object({
    oldPassword: zod
      .string()
      .min(1, "Old password is required")
      .min(3, "Old password is too short"),
...
export default function ChangePassword() {
  ...
  async function passwordapi(data) {
  ...
  const {
    ...
    resolver: zodResolver(passwordobj),
  });

  async function onSubmit(data) {
    try {
      setApiError("");
      await passwordapi(data);
      reset();
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  classNames={{
                    inputWrapper:
                      "border-default-200 hover:border-primary transition",
                  }}
                  endContent={
                    <button
